...
| Mode | What you do |
|------|-------------|
| **Quick swap** | **Swap:** team player → rest of squad. **Add:** select rest of squad → Move to team (or swap with someone on a team); if full, pick who moves to rest of squad |
